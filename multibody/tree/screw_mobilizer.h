...
/* This mobilizer models a screw joint between an inboard frame F and an
 ...
 depends on and proportional to rotation θ. Their relation is defined by screw
 pitch. The translation (z) is defined to be positive in the direction of frame
 F's z-axis axis and the rotation θ is defined to be positive according to the
 ...
 public:
  ...
  /* Constructor for a %ScrewMobilizer between an inboard frame F
   ...
   @param[in] screw_pitch The amount of translation along F's z-axis in meters
                          for a one full circle turn about F's z-axis*/
